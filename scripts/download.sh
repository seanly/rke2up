...
do_download_verify_file() {
    ...
    curl -sfL $_target_url > ${_release_dir}/${_sha256sum_file}
}
...
do_download_rke2() {
    ...
    curl -sfL $_target_url > ${_release_dir}/${_rke2_package_file}
}
...
do_download_rke2_core_images() {
    ...
    curl -sfL $_target_url > ${_release_dir}/${_rke2_core_images}
}
...
do_download_rke2_calico_images() {
    ...
    curl -sfL $_target_url > ${_release_dir}/${_rke2_calico_images}
}
